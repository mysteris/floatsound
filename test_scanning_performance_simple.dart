...
void main() async {
  ...
  try {
    ...
    print('✓ Average time per file: ${scannedMusic.isNotEmpty ? stopwatch.elapsedMilliseconds / scannedMusic.length : 0}ms');
    
    // Test 3: Test with larger batch
    ...
    print('✓ Average time per file: ${largeScannedMusic.isNotEmpty ? largeStopwatch.elapsedMilliseconds / largeScannedMusic.length : 0}ms');
